            ...
            <nav class="col-sm-3 col-md-2 hidden-xs-down bg-faded sidebar">
                <ul class="nav nav-pills flex-column">
                    <li class="nav-item main-menu-item">
                        <a class="nav-link active" href="#" id="boots">Обувь</a>
                    </li>
                    <ul class="nav-pills flex-column sub-menu-item">
                        <li class="nav-item">
                            <a class="nav-link" href="#" id="football_boots">Футбольные бутсы</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#" id="indoor">Обувь для зала</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#" id="outdoor">Шиповки</a>
                        </li>
                    </ul>
