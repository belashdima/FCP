                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="demo" class="collapse">
                            <li>
                                <a id="football_boots" class="sub-menu-item" href="javascript:;">Футбольные бутсы</a>
                            </li>
                            <li>
                                <a id="indoor_boots" class="sub-menu-item" href="javascript:;">Обувь для зала</a>
                            </li>
                            <li>
                                <a class="sub-menu-item" href="#">Шиповки</a>
                            </li>
                        </ul>
                    </li>
                    <li>
...
-->
    ...
    <script src="js/contentItem.js"></script>
